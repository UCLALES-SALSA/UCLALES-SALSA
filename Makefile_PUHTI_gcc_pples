...
MPI = $(OPENMPI_INSTALL_ROOT)
MPILIB = -L$(MPI)/lib -lmpi
MPIINC = -I$(MPI)/include

NCDF = $(NETCDF_FORTRAN_INSTALL_ROOT)
...
F90 = gfortran
MPIF90 = mpif90
FFLAGS = -O2 -fdefault-real-8  -std=f2008
...
$(LES_OUT_SEQ): 
	...
	FFLAGS='$(FFLAGS) $(SEQFFLAGS)'                     \
	F77FLAGS='$(F77FLAGS)' F90=$(F90)       \
...
$(LES_OUT_MPI):
	...
	FFLAGS='$(FFLAGS) $(MPIFFLAGS)'                     \
	F77FLAGS='$(F77FLAGS)' F90=$(MPIF90)   \
